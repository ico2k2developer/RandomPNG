...
// RandomPNGgui.cpp: definisce i comportamenti delle classi per l'applicazione.
//
...
BEGIN_MESSAGE_MAP(CRandomPNGguiApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Costruzione di CRandomPNGguiApp

CRandomPNGguiApp::CRandomPNGguiApp()
{
...
// Unico oggetto CRandomPNGguiApp

CRandomPNGguiApp theApp;


// Inizializzazione di CRandomPNGguiApp

BOOL CRandomPNGguiApp::InitInstance()
{
